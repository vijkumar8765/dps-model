package com.it.bp.dps.domain.entity.dao.impl;

import com.it.bp.dps.domain.entity.DedelDealsDBO;
import com.it.bp.dps.domain.entity.base.impl.EntityManagerBaseImpl;
import com.it.bp.dps.domain.entity.dao.DedelDealsDao;

public class DedelDealsDaoImpl extends EntityManagerBaseImpl<DedelDealsDBO, Integer> implements DedelDealsDao {
    ...
    //private static Logger logger = Logger.getLogger(DedelDealsDaoImpl.class);

    public DedelDealsDaoImpl() {
        super(DedelDealsDBO.class);
    }
